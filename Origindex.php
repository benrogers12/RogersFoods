...
<br><br>
<b>Enter a new recipe below.</b><br>
...
if(mysqli_connect_errno()) {
 ...
 if(isset($_POST['submit'])){           //Checks for the button to be pressed
        ...
        echo "There were $rows recipes found <br><br><br>";
		 while ($row = $result->fetch_array(MYSQLI_ASSOC)){
                printf("<h3>%s</h3><br>%s %s<br><b>Ingredients</b><br>%s<br><b>Instructions</b><br>%s<br><br>", $row['rName'], $row['category'], $row['category2'], $row['ingredients'], $row['instructions']);
        }
